...
Config.TARGET_RANGE     = 185   -- max auto-target acquisition distance, default: 320
...
------------------------------------
-- Sailing Instructions screen --
------------------------------------
-- SailingInstructions (see source/scenes/SailingInstructions.lua): a
-- narrative, Zeus-narrated remedial lesson reached from InstructionsScene's

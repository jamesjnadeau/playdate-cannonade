...
Config.ENEMY_SWORDFISH_LENGTH     = math.floor(Config.ENEMY_LENGTH * 0.65) -- half-length of hull body (excludes bill), smaller than the base enemy
Config.ENEMY_SWORDFISH_BEAM       = math.floor(Config.ENEMY_BEAM * 0.55)   -- half-width of hull when drawn, slimmer than the base enemy
...
Config.ENEMY_SWORDFISH_RADIUS     = Config.ENEMY_SWORDFISH_LENGTH          -- collision radius (bill doesn't count -- it's a visual flourish)
Config.ENEMY_SWORDFISH_HEALTH     = 1
Config.ENEMY_SWORDFISH_DAMAGE     = Config.ENEMY_DAMAGE
